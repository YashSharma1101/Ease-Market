 ...
 */
@WebServlet("/ChangePasswordChecker2")
public class ChangePasswordChecker2 extends HttpServlet {
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			if (i > 0) {
				...
				rd.include(request, response);
				out.println("<script>window.alert('Please Enter Correct Email ');</script>");
