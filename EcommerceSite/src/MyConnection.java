...
public class MyConnection {
	...
	public static Connection getConnection() {
		...
		try {
			...
			/*
			 * 1. URL: "jdbc:mysql://", is the address "localhost: " is the
			 * local machine and "3306" is the port number and
			 * "FileUploadDatabase" is the name of the database.
			 * 
			 * 2. UserName: "root", which is set while creating a database
			 * server in MySql Workbench. 3. Password: "root"
			 */
